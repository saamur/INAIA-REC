...
from ernestogym.envs.multi_agent.utils import get_world_metadata_from_template, get_world_data
...
def main():
    ...
    world_metadata = get_world_metadata_from_template('3_agents_passive_only_local', world_kwargs={'reward': {
            'trading_coeff': 1,
    ...
    config = {
        ...
        'USE_REC_RULE_BASED_POLICY': True,      # dummy: it won't have any effect since the global reward is weighted by 0
        'REC_RULE_BASED_NAME': 'uniform',
